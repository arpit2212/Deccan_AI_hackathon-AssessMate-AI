      ...
      >
        <div className="text-center mb-10">
          <motion.div
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
            className="inline-block p-3 bg-primary-light rounded-2xl mb-4"
          >
            <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-white text-2xl font-bold">
              DNA
            </div>
          </motion.div>
          <h1 className="text-4xl font-extrabold tracking-tight mb-2 text-primary">AssessMate</h1>
          <p className="text-text-secondary text-lg">From Resume to Reality.</p>
        </div>
        ...
        <Card className="border border-gray-100 p-8">
          ...
          <Button
            ...
            variant="outline"
            className="w-full flex items-center gap-3 py-6 border-2 hover:border-primary hover:bg-primary-light transition-all"
          >
